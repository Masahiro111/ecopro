...
<head>
  <meta charset="utf-8">
	...
	<!-- Vendors Style-->
	<link rel="stylesheet" href="{{ asset('theme/css/vendors_css.css?a') }}">
	  
	<!-- Style-->  
	<link rel="stylesheet" href="{{ asset('theme/css/style.css?a') }}">
	<link rel="stylesheet" href="{{ asset('theme/css/skin_color.css?a') }}">
	<style>
		/* .bg-gradient-primary, .theme-primary .bg-gradient-primary, .theme-primary .art-bg {
			background: linear-gradient(45deg, #e4e4e4, #d3d3d3);
		} */
	</style>
							...
							<form action="{{ isset($guard) ? url($guard. '/login') : route('login') }}" method="POST">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="email" type="email" name="email" :value="old('email')" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email" required autofocus>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="password" name="password" type="password" class="form-control pl-15 bg-transparent text-white plc-white" />
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
