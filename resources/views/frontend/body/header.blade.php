                                        ...
                                        <div class="col-xs-4">
                                            <div class="image">
                                                <a href="detail.html">
                                                    <img src="{{
                                                            asset(
                                                                'frontend/assets/images/cart.jpg'
                                                            )
                                                        }}" alt="" /></a>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image">
                                                        <img class="img-responsive" src="{{
                                                                asset(
                                                                    'frontend/assets/images/banners/top-menu-banner.jpg'
                                                                )
                                                            }}" alt="" />
                                                    </div>
                                                    <!-- /.yamm-content -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner">
                                                        <a href="#">
                                                            <img alt="" src="{{
                                                                    asset(
                                                                        'frontend/assets/images/banners/banner-side.png'
                                                                    )
                                                                }}" />
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-menu">
                                                        <ul class="links">
                                                            ...
                                                            <li>
                                                                <a href="terms-conditions.html">Terms and
                                                                    Condition</a>
                                                            </li>
                                                            <li>
                                                                <a href="track-orders.html">Track
                                                                    Orders</a>
                                                            </li>
                                                            <li>
